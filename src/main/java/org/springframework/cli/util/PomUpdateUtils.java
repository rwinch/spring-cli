...
import org.springframework.cli.merger.ChangeNewlyClonedPomRecipe;
import org.springframework.cli.recipe.RecipeUtils;

public class PomUpdateUtils {
	private static final Logger logger = LoggerFactory.getLogger(PomUpdateUtils.class);

	public void updatePom(Path repositoryContentsPath, ProjectInfo projectInfo) {
		// Get Files
