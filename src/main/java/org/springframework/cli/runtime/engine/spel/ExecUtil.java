...
public class ExecUtil {
	...
	public ExecUtil(ExecActionHandler execActionHandler) {
	...
	public String execCommandFile(String commandFile) {
		Exec exec = new Exec(null, null, commandFile, null, null, null);
		Map<String, Object> outputs = new HashMap<>();
		execActionHandler.executeShellCommand(exec, outputs);
		String output = outputs.get(ExecActionHandler.OUTPUT_STDOUT).toString();
		return output;
	}
